...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleWebClientRequestException(WebClientRequestException ex) {
        if (ex.getCause() instanceof ConnectException) {
            logger.error("Customer Service is down from Product Service: {} | traceId={}", ex.getMessage(), getTraceId());
        ...
        logger.error("WebClient request failure from Product Service: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleGeneralException(Exception ex) {
        logger.error("Unexpected exception in Product Service: {} | traceId={}", ex.getMessage(), getTraceId(), ex);
