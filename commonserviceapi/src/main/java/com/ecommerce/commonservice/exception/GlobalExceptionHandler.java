...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleWebClientRequestException(WebClientRequestException ex) {
        if (ex.getCause() instanceof ConnectException) {
            logger.error("Downstream service unavailable: {} | traceId={}", ex.getMessage(), getTraceId());
        ...
        logger.error("WebClient request failure: {} | traceId={}", ex.getMessage(), getTraceId());
    ...
    public ResponseEntity<ErrorResponse> handleGeneralException(Exception ex) {
        logger.error("Unexpected exception: {} | traceId={}", ex.getMessage(), getTraceId(), ex);
